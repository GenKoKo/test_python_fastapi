...
# 導入配置和日誌
from src.core import settings, validate_config, print_config, app_logger, log_startup, log_shutdown
...
async def shutdown_event():
    ...
    log_shutdown()
    stats = db.get_stats()
    app_logger.info(f"📊 最終統計: {stats['items']['total']} 個商品, {stats['users']['total']} 個用戶")